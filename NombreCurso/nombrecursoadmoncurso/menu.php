...
<body>
	...
	<?php
	include ('conex.php');
	$results= mysql_query("select Correo,Password,tipo from usuarios where Correo ='".$cookie_value."'");
...
<tr>
  <td bordercolor="#000000"><div align="center">
        ...
        <label>
          ...
          <input name="work3" class="btn btn-primary" type="submit" id="work3" value="Cursos"  onclick="location='usuarios.php'"/>
          <input name="work2" class="btn btn-primary" type="submit" id="work2" value="Dependencia"  onclick="location='Dependencias/usuarios.php'"/>
	...
	<?php
	include ('conex2.php');
	$r= mysql_query("select Correo,Password,tipo from usuarios where Correo ='".$cookie_value."'");
...
<tr>
  <td bordercolor="#000000"><div align="center">
        ...
        <label>
          <input name="work5" class="btn btn-primary" type="submit" id="work5" value="Areas"  onclick="location='Areas/usuarios.php'"/>
          <input name="work4" class="btn btn-primary" type="submit" id="work4" value="Capacitadores"  onclick="location='concap.php'"/>
          <input name="work3" class="btn btn-primary" type="submit" id="work3" value="Cursos"  onclick="location='usuarios.php'"/>
          <input name="work2" class="btn btn-primary" type="submit" id="work2" value="Dependencia"  onclick="location='Dependencias/usuarios.php'"/>
          <input name="user" class="btn btn-primary" type="submit" id="user" value="usuarios" onclick="location='usuarios/usuarios.php'"/>
        </label>
