<?php
	...
	/*Inicia validacion del lado del servidor*/
	 if (empty($_POST['id_nombrecurso'])){
			$errors[] = "ID vacío";
		}   else if (
			!empty($_POST['id_nombrecurso']) 
			
		){

		// escaping, additionally removing everything that could be (html/javascript-) code
		$id_nombrecurso=intval($_POST['id_nombrecurso']);
		
//		$sql="DELETE FROM personas WHERE id='".$id_pais."'";
		$sql="UPDATE nombrecurso SET Estatus = 'Suspendido' WHERE Id='".$id_nombrecurso."'";
