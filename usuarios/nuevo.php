...
if(isset($_POST['submit'])){
	...
	if ( $objCliente->insertar(array($Correo,$Password,$NivelUS,$Id__Persna,$TipoUS)) == true){
		...
		var respuesta=confirm("La area fue dada de alta, Desea regresar al menu inicial") 
		if (respuesta==true)
...
<form id="frmClienteNuevo" name="frmClienteNuevo" method="post" action="nuevo.php" onSubmit="GrabarDatos(); return false">
  ...
  <label id="icon" for="name"><i class="icon-user"></i></label>
  <label> Nivel
  <input class="text" type="text" name="NivelUS" id="NivelUS" />
  </label>
  </p>
  <hr>
  <label id="icon" for="name"><i class="icon-user"></i></label>
  ...
  <select name="TipoUS" id="TipoUS">
    <option value="Trabajador" >Trabajador
    <option value="Capacitador">Capacitador
  </select>
  <hr>
  <label id="icon" for="name"><i class="icon-user"></i></label>
  <label>Nombre  </label>
